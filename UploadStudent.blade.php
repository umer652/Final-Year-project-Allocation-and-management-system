...
<head>
  ...
  <title>Upload Student - Admin Dashboard</title>
    ...
    <div class="menu">
      <div class="add-container">
        ...
        <div class="add-menu">
          ...
          <button onclick="window.location.href='{{ route('admin.upload_commettie') }}'">Add Committee</button>
        </div>
      </div>
  ...
  <div class="main-container">
    ...
    <div class="main-content">
      <div class="upload-card">
        ...
        <a href="{{ asset('templates/student_template.xlsx') }}" download>📄 Download Excel sheet</a>

        <form action="{{ route('admin.upload_student.upload') }}" method="POST" enctype="multipart/form-data">
          @csrf
          ...
          <button type="submit" class="upload-btn">Upload Student</button>
        </form>

        <div class="note">
          <h3>📝 Note:</h3>
          <ul>
            <li>Accepted file format: .xlsx, .csv</li>
            <li>Required fields: <b>Name,NUN_Number,Email,CGPA,Phase</b></li>
          </ul>
        </div>
      </div>
    </div>
